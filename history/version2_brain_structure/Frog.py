...
from history.version2_brain_structure.brain.Cell import Cell
from history.version2_brain_structure.brain.IO import Input,Output
from history.version2_brain_structure.egg.Egg import Egg
from history.version2_brain_structure.egg.Zone import Zone
from history.version2_brain_structure.egg.CellGroup import CellGroup
from configs import *
...
class Frog(object):
    ...
    def __init__(self,x:float,y:float,egg:Egg,tk:Tk,canvas:Canvas):
        ...
        self.egg:Egg=egg#保留一份蛋,如果没被淘汰掉,将来下蛋时要用这个蛋来下新蛋
